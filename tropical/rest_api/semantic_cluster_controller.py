"""
Flask controller for the semantic_cluster model.
"""

from tackle.rest_api.flask_server.controllers import controller_util
from tropical.rest_api import semantic_cluster_wrapper
...
def start_process_url(user, token_info,
    ...
    response_code, response_json = semantic_cluster_wrapper.start_process_url(auth_token=auth_token,
...
def start_process_form(user, token_info,
    ...
    response_code, response_json = semantic_cluster_wrapper.start_process_form(auth_token=auth_token,
                                                                               caller_name=caller_name,
                                                                               upfile=upfile,
                                                                               file_format_version=file_format_version,
                                                                               callback=callback)
