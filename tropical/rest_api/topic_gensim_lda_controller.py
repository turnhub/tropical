"""
Flask controller for the topic model - Gensim implementation of LDA.
"""
...
def start_process_url(user, token_info, request_detail):
...
@controller_util.controller_decorator
def start_process_form(user, token_info, **kwargs):
    auth_token = controller_util.get_auth_token()
    caller_name = controller_util.get_caller_name()
